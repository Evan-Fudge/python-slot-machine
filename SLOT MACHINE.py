...
def get_bet():
    while True:
        ...
        if amount.isdigit():
            ...
            print("Please enter a valid bet. between"+ str(MIN_BET) + "and" +str(MAX_BET))
    return amount
...
def spin(balance):
    ...
    print(f"Your bet is ${bet} on {lines} lines. Your total bet is {total_bet}$.")
...
def main():
    ...
    while True:
        ...
        answer = input("Press enter to play. (q to quit the game).")
        if answer  == "q":
            break
